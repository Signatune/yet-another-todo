...
function project(title, todos) {
  function newTodo() {
    ...
    _projectController_js__WEBPACK_IMPORTED_MODULE_1__.addTodo(
      todoName.value,
...
function Todo(name, description, dueDate, expanded, projectName) {
  function remove() {
    _projectController_js__WEBPACK_IMPORTED_MODULE_0__.removeTodo(name, projectName);
  }

  function render() {
    let todoEl = document.createElement("li");
    let formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dueDate), "MM/dd/yyyy");
    ...
    todoEl.querySelector("button.increase").addEventListener("click", () => {
      _projectController_js__WEBPACK_IMPORTED_MODULE_0__.increaseTodoPriority(name, projectName);
    });
    todoEl.querySelector("button.decrease").addEventListener("click", () => {
      _projectController_js__WEBPACK_IMPORTED_MODULE_0__.decreaseTodoPriority(name, projectName);
    });
    todoEl.querySelector("button.expand").addEventListener("click", () => {
      _projectController_js__WEBPACK_IMPORTED_MODULE_0__.toggleTodoExpand(name, projectName);
    });
...
_projectController_js__WEBPACK_IMPORTED_MODULE_0__.initialize();
...
/* harmony export */   decreaseTodoPriority: () => (/* binding */ decreaseTodoPriority),
/* harmony export */   increaseTodoPriority: () => (/* binding */ increaseTodoPriority),
/* harmony export */   initialize: () => (/* binding */ initialize),
/* harmony export */   removeTodo: () => (/* binding */ removeTodo),
/* harmony export */   toggleTodoExpand: () => (/* binding */ toggleTodoExpand)
/* harmony export */ });
/* harmony import */ var _view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view.js */ "./src/view.js");
/* harmony import */ var _projectModel_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projectModel.js */ "./src/projectModel.js");



function initialize() {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.initializeState();
  _view_js__WEBPACK_IMPORTED_MODULE_0__.initialize();
  updateView();
}

function createProject(name) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.createProject(name);
  updateView();
}

function addTodo(name, description, dueDate, expanded, projectName) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.addTodo(name, description, dueDate, expanded, projectName);
  updateView();
}

function removeTodo(name, projectName) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.removeTodo(name, projectName);
  updateView();
}

function increaseTodoPriority(name, projectName) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.increaseTodoPriority(name, projectName);
  updateView();
}

function decreaseTodoPriority(name, projectName) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.decreaseTodoPriority(name, projectName);
  updateView();
}

function toggleTodoExpand(name, projectName) {
  _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.toggleTodoExpand(name, projectName);
  updateView();
}

function updateView() {
  let state = _projectModel_js__WEBPACK_IMPORTED_MODULE_1__.getState();

  _view_js__WEBPACK_IMPORTED_MODULE_0__.update(state);
}
...
function initializeState() {
  if (localStorage.length == 0) {
    return createProjectOnState({}, "Reminders");
  } else {
    let reloadedState = {};
...
function addTodoOnState(
  ...
  return {
    ...
    [projectName]: (0,_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"])(projectName, [
      ...existingTodos,
      (0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(name, description, dueDate, expanded, projectName),
    ]),
  };
}
...
function removeTodo(name, projectName) {
  ...
  state = {
    ...state,
    [projectName]: (0,_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"])(projectName, remainingTodos),
  };
...
function toggleTodoExpand(name, projectName) {
  ...
  state[projectName].todos[todoIndex] = (0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(
    todo.name,
    todo.description,
    todo.dueDate,
    !todo.expanded,
